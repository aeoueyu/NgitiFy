...
export default function DentistDashboard({ navigation }) {
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                <View>
                    ...
                    <Text style={styles.role}>Attending Dentist</Text>
                </View>
            ...
            <Animated.View style={{ flex: 1, opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
                <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
                    ...
                    <TouchableOpacity style={[styles.actionCard, { width: '100%', flexDirection: 'row', alignItems: 'center' }]} onPress={() => navigation.navigate('MyEarnings')}>
                        <View style={{marginRight: 15}}>
                            <EarningsCommissionIcon width={35} height={35} />
                        </View>
                        <View style={{flex: 1}}>
                            <Text style={[styles.cardTitle, { textAlign: 'left' }]}>My Earnings</Text>
                            <Text style={{ fontSize: 12, color: '#888', marginTop: 5 }}>Track your procedure commissions.</Text>
                        </View>
                    </TouchableOpacity>
