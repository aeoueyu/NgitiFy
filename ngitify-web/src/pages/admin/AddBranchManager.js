// ngitify-web/src/pages/admin/AddBranchManager.js
import React, { useState, useRef, useEffect } from 'react';
import styles from '../../styles/admin/AddSecretary.module.css'; // Reuse secretary styles
...
export default function AddBranchManager({ onClose, onSuccess }) {
    ...
    // ✅ PHASE 2: Fetch branches for the dropdown
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await authFetch('/add-branch-manager', {
                method: 'POST',
            ...
            if (response.ok) {
                ...
                if (response.status === 409) {
                    ...
                    alert(data.message || 'Failed to add branch manager');
                }
            }
        } catch (error) {
            console.error(error);
            ...
            <div className={styles.formCard}>
                <div className={styles.headerWrapper}>
                    ...
                    <div className={styles.header}>
                        ...
                        <p>Enter the branch manager's personal details below.</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} noValidate>
                    ...
                    {branchOptions.length > 0 && (
                        <>
                            ...
                            <p style={{ color: '#64748b', fontSize: '13px', marginBottom: '15px', marginTop: '-15px' }}>Select the branches this manager will oversee.</p>
                    ...
                    <div className={styles.buttonGroup}>
                        ...
                        <button type="submit" className={styles.submitBtn} disabled={isLoading}>{isLoading ? 'ADDING...' : 'ADD BRANCH MANAGER'}</button>
                    </div>
                </form>
            </div>
            ...
            {showSuccessModal && (
                <div className={styles.modalOverlay}>
                    <div className={styles.modalCard}>
                        ...
                        <p className={styles.modalMessage}>New branch manager has been successfully added. An activation email has been sent.</p>
