        ...
        const fetchData = async () => {
            try {
                ...
                if (userRes.ok) {
                    ...
                    alert('Failed to load co-administrator data.');
                    onClose();
                }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setErrorMessage(data.message || 'Failed to update co-administrator.');
            }
        } catch (e) {
            console.error(e);
                    ...
                    <>
                        <div style={{ marginBottom: '24px' }}>
                            <h2 style={{ fontSize: '22px', fontWeight: '700', color: '#01538b', margin: 0 }}>
                                Edit Co-Administrator
                            </h2>
                            <p style={{ color: '#64748b', fontSize: '14px', marginTop: '4px' }}>
                                Update the co-administrator's information below.
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className={styles.buttonGroup}>
                                ...
                                <button type="submit" className={styles.submitBtn} disabled={isSaving || !hasChanges}>
                                    {isSaving ? 'Saving...' : 'Update Co-Administrator'}
                                </button>
                            </div>
                        </form>
                    </>
            ...
            {showSuccessModal && (
                <div style={{ position: 'fixed', inset: 0, zIndex: 1100, display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(0,0,0,0.5)' }}>
                    <div style={{ backgroundColor: '#fff', borderRadius: '12px', padding: '40px', textAlign: 'center', maxWidth: '360px', width: '90%' }}>
                        ...
                        <p style={{ color: '#64748b', marginBottom: '24px' }}>Co-administrator profile updated successfully.</p>
