...
const AddCoAdmin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const data = await res.json();
            if (res.ok) {
                setSuccessMessage('Co-Administrator added successfully! Activation email sent.');
                setFormData({ firstName: '', lastName: '', email: '', phone: '', assignedBranches: [] });
            } else {
                setErrorMessage(data.message || 'Failed to add co-administrator.');
            }
        } catch (e) {
            ...
            <div className={styles.formCard}>
                ...
                <form onSubmit={handleSubmit} className={styles.form}>
                    ...
                    <div className={styles.formRow}>
                        <div className={styles.formGroup}>
                            ...
                            <input type="text" name="firstName" value={formData.firstName}
                                onChange={handleChange} className={styles.input} required disabled={isLoading} />
                        </div>
                        <div className={styles.formGroup}>
                    ...
                    <div className={styles.formRow}>
                        ...
                        <div className={styles.formGroup}>
                            ...
                            <input type="tel" name="phone" value={formData.phone}
                                onChange={handleChange} className={styles.input} disabled={isLoading} />
                        </div>
                    </div>
                    ...
                    <div className={styles.buttonGroup}>
                        <button type="button" className={styles.cancelBtn} onClick={() => navigate(-1)} disabled={isLoading}>Cancel</button>
