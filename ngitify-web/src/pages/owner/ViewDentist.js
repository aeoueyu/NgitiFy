...
import formStyles from '../../styles/owner/AddDentist.module.css';
import styles from '../../styles/owner/ViewDentist.module.css';
                    ...
                    <>
                        <div className={formStyles.headerWrapper}>
                            ...
                            <div className={formStyles.header}>
                                <h2>
                                    View <span className={formStyles.highlight}>Dentist</span> Profile
                                </h2>
                                <p>This user&apos;s profile details (read-only).</p>
                            </div>
                        </div>
                        ...
                        <div className={styles.viewRow}>
                            <div className={styles.viewField}>
                                ...
                                <div className={styles.viewValue}>{displayName}</div>
                            </div>
                            <div className={styles.viewField}>
                        ...
                        <div className={styles.viewRow}>
                            <div className={styles.viewField}>
                                <div className={styles.viewLabel}>LICENSE NO.</div>
                                <div className={styles.viewValue}>{data.licenseNumber || '—'}</div>
                            </div>
                            <div className={styles.viewField}>
                                <div className={styles.viewLabel}>SPECIALIZATION</div>
                                <div className={styles.viewValue}>{data.specialization || '—'}</div>
                            </div>
                        </div>
