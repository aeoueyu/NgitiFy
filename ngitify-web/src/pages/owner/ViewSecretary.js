...
import formStyles from '../../styles/owner/AddSecretary.module.css';
import styles from '../../styles/owner/ViewSecretary.module.css';
...
export default function ViewSecretary({ secretaryId, onClose, onEdit }) {
    ...
    useEffect(() => {
        if (secretaryId) fetchUser();
    }, [secretaryId, fetchUser]);
                    ...
                    <>
                        <div className={formStyles.headerWrapper}>
                            ...
                            <div className={formStyles.header}>
                                <h2>
                                    View <span className={formStyles.highlight}>Secretary</span> Profile
                                </h2>
                                <p>This staff member&apos;s details (read-only).</p>
                            </div>
                        </div>
