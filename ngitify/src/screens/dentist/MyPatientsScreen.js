...
const DENTIST_PATIENTS = [
    ...
    { id: '2', firstName: 'Jane', lastName: 'Doe', email: 'jane.doe@gmail.com', phone: '09554446666', birthdate: '1990-02-14', conditions: ['None'], allergies: 'None' },
    { id: '3', firstName: 'Pedro', lastName: 'Penduko', email: 'pedro@gmail.com', phone: '09223334444', birthdate: '2000-12-25', conditions: ['High Blood Pressure'], allergies: 'Penicillin' },
];

export default function MyPatientsScreen({ navigation }) {
    const [searchQuery, setSearchQuery] = useState('');
    const [filteredPatients, setFilteredPatients] = useState(DENTIST_PATIENTS);
    ...
    const renderPatientCard = ({ item }) => {
        ...
        return (
            <TouchableOpacity 
                style={styles.card} 
                activeOpacity={0.7}
                onPress={() => navigation.navigate('PatientProfile', { patient: { ...item, age } })}
            >
                ...
                <View style={styles.viewBtn}>
                    <Text style={styles.viewBtnText}>Open Medical Profile ➔</Text>
                </View>
            </TouchableOpacity>
        );
    };
...
const styles = StyleSheet.create({
    ...
    viewBtn: { backgroundColor: '#f3f7f9', padding: 12, borderRadius: 50, alignItems: 'center' },
    viewBtnText: { color: '#01538b', fontWeight: 'bold', fontSize: 13 }
});